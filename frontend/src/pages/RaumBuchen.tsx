...
import { conferenceRooms, standorte, type ConferenceRoom } from "@/lib/mock-data"
    ...
    <div className="mx-auto max-w-5xl space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Zeitraum wählen und verfügbaren Konferenzraum auswählen.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div className="space-y-3 lg:col-span-2">
          {conferenceRooms.map((room) => {
            const standort = standorte.find((s) => s.id === room.locationId)
                ...
                <div className="flex items-start justify-between gap-2">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {standort?.name} · {room.capacity} Personen
                    </p>
                  </div>
                  {room.occupied ? (
            ...
            <Card className="sticky top-20">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {standorte.find((s) => s.id === selectedRoom.locationId)?.name}
                  </p>
                </div>
                ...
                <Button className="w-full" onClick={() => navigate("/buchungen/neu")}>
                  Raum bestätigen
                </Button>
              </CardContent>
            </Card>
